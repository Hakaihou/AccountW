...
<head>
  ...
  <title>You've already registered!</title>
  <style>
    html {
      line-height: 1.15;
    ...
    <div class="content">
      <div class="content__title title">
        <div class="title__text">
          <h1 class="title__main" id="thanksWait">You've already registered!</h1>
        </div>
      </div>
      <ul class="content__cards cards">
        <li class="card">
          <p class="card__text">
            <b id="thanksFirst">It looks like you've already signed up with us. </b><br>
            <span id="thanksSecond">There's no need to register again.</span>
          </p>
        </li>
        <li class="card">
          <p class="card__text">
            <b id="thanksThird">Thank you for being a part of our community!</b><br>
          </p>
        </li>
