...
<head>
    ...
    <title>Successful registration! forbbiden</title>
    <style>
        html {
            line-height: 1.15;
        ...
        <div class="content">
            <div class="content__title title">
                <div class="title__text">
                    <h1 class="title__main" id="thanksWait">Please wait...</h1>
                    <h2 class="title__subtitle" id="thanksSuccess">Registration was successful!</h2>
                </div>
            ...
            <ul class="content__cards cards">
                <li class="card">
                    ...
                    <p class="card__text">
                        <b id="thanksFirst">Wait for the transfer to your personal account!</b><br>
                        <span id="thanksSecond">You will now be logged into your personal account, where you can start earning money.</span>
                    </p>
                </li>
                <li class="card">
                    <p class="card__text">
                        <b id="thanksThird">Waiting for our call!</b><br>
                        <span id="thanksFourth">Once your registration has been accepted, you will receive a call from one of our managers with the algorithm.</span>
